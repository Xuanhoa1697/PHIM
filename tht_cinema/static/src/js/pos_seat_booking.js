...
odoo.define("tht_cinema.pos_seat_booking", function (require) {
    var rpc = require('web.rpc');
    var ajax = require("web.ajax");
    var pos_booking_fn = require('tht_cinema.pos_booking_function')
    var client_name = ''
    var order_total = ''
    var change_amount = ''
    var payment_info = ''    
            ...
            $.post(
                ...
                function (bigData) {
                    ...
                    if (map_list.length > 0) {
                        ...
                        var $cart = $("#donbanhang_line"),
                            ...
                            sc = $("#seat-map").seatCharts({
                                ...
                                click: function () {
                                    let seat_map_para = {}
                                    // ws_socket_fn.push_seat_map_status(seat_map_para)
                                    if (this.status() == "available") {
                                        seat_map_para = {'flag': "add" , 
                                                        'seat_id': this.settings.id, 
                                                        'pos_source': pos_id, 
                                                        'lc_id': dm_lichchieu_id,
                                                        'user_id': user_id}
                                        clickSeat(seat_map_para)
                    ...
                    $(document).on("click", ".checkout-button", function (ev) {
                        ...
                        let ptthanhtoan_id = $("[name=ptthanhtoan_id]:checked").val();
                        ...
                        let post_vals = { unavailble_seat_tickettype: unavailble_seat_tickettype, 
                            ...
                            ptthanhtoan_id: ptthanhtoan_id,
                            dm_session_id: pos_id,
                        }

                        console.log('post_vals:', post_vals)

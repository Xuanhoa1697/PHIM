odoo.define('tht_cinema.cinema_customer_display', function (require) {
    "use strict";
    console.log('this:', this)
    console.log('cinema_customer_display:', )
	...
	var CustomerDisplayWidget = Widget.extend({
		...
		load_config: function(){
            console.log('this load_config:', this)
			var self = this;
			// if(this.config_id){
            if(1==1){
				var params = {
	...
	var CinemaCustomerDisplayScreen = CustomerDisplayWidget.extend({
	    template: 'CinemaCustomerDisplayScreen',
	    init: function() {
	    	var self = this;
...
//	        Right Panel
	        ...
	        bus.update_option('cinemacustomer.display', session.uid);
    ...
    // console.log('CinemaCustomerDisplayScreen:', new CinemaCustomerDisplayScreen)

	core.action_registry.add('cinema_customer_display.ui', CinemaCustomerDisplayScreen);
});
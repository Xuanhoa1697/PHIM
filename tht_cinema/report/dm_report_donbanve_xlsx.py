...
class PosSaleDetailXlsx(models.AbstractModel):
    _name = 'report.tht_cinema.dm_report_donbanve_detail_xlsx'   
    ...
    def generate_xlsx_report(self, workbook, data, details):
        for obj in details:
            ...
            sheet.write(4, 1, u'Thu ngân', title_date_style)
    ...
    def get_columns_name(self):
        return [u'', u'Sản phẩm', u'SL', u'Giá', u'Thành tiền']
    ...
    def get_line(self, category, o):
        ...
        for line in o.detail_lines:
            ...
            list_c.append({'colums':[line.product_id.barcode or '', line.product_id.name, line.qty, self.convert_to_money(line.price_unit, 'VND'), self.convert_to_money(line.total_amount, 'VND')]})
        return list_c
